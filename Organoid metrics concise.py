...
def individual_plot(processed_data_idx, output_dir):
    """Generate and save plots for adjacency matrices."""
...
density_levels = density_levels[:1] # For testing

# Load data
matrix_files = load_files(matrix_dir=matrix_dir)
matrix_files = matrix_files[:1] # For testing
print(f'{len(matrix_files)} organoid files loaded.')
